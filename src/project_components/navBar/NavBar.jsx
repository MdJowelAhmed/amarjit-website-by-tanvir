            ...
            if (nav.children) {
              return (
                <NavigationMenuItem key={nav.id}>
                  <NavigationMenuTrigger className="bg-transparent text-white text-xl data-[state=open]:text-[#7181E8] data-[state=open]:underline">
                    {nav.label}
                  </NavigationMenuTrigger>
                  <NavigationMenuContent>
                          ...
                          <NavigationMenuLink asChild>
                            <Link
                              ...
                              className={cn(
                                ...
                                isActive(child.link) && "underline text-[#7181E8]"
                              )}
                            >
