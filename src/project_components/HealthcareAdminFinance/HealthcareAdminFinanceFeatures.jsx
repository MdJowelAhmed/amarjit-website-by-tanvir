	...
	return (
		<div className="flex flex-col lg:flex-row lg:items-start lg:justify-between p-4 sm:p-6 lg:p-8 gap-6 lg:gap-8 text-black mb-10">
			<div className="flex-1 lg:max-w-[55%]">
				<div>
					<h1 className="text-gradient-heading text-2xl sm:text-3xl lg:text-6xl font-bold w-full leading-20 ">
					...
					<div>
						<ul className="mt-4 sm:mt-6 space-y-3 sm:space-y-3 list-disc pl-4 sm:pl-6 lg:pl-8">
							...
							<li>Patient Access Specialists</li>
							<li>Case Managers & Social Workers</li>
							<li>Medical Receptionists & Front Desk</li>
							<li>Certified Nursing Assistants (CNA) (optional)</li>
						</ul>
					</div>
				</div>
				<div>
