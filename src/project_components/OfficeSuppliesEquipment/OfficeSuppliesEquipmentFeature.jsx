...
function OfficeSuppliesEquipmentFeature() {
	return (
		<div className="min-h-screen lg:py-24 text-black">
			<div className="relative z-10 container mx-auto px-6 py-8">
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
					{/* Left Column - Main Content */}
					<div className="lg:col-span-2 space-y-6">
						{/* Header */}
						<h1 className="text-gradient-heading  text-2xl sm:text-3xl lg:text-6xl font-bold leading-20">
					...
					<div className="space-y-6">
						<div>
							<Image
								src="/Home/Product Provisioning/ooffice_supplies.png"
								alt="Office Supplies"
								width={400}
								height={300}
						...
						{/* Why Choose Us */}
						<div className=" rounded-lg p-6 border-2 border-[#4f3075]">
							<h2 className="text-3xl font-bold mb-6 text-gradient-heading ">
								Why Choose Us?
							</h2>
