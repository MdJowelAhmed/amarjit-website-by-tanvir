        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            <div className="flex items-start justify-center gap-4 mb-6">
              <div className="pt-2">
                {provideIcon({ name: "core_offering" })}
              </div>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold bg-gradient-to-b from-[#2C2D70] to-[#512C7B] bg-clip-text text-transparent mb-2 sm:mb-4 leading-20">
                Our Core Offerings
              </h2>
            </div>

            <p className="text-base sm:text-lg lg:text-xl text-[#181818] max-w-4xl mx-auto leading-relaxed">
              We provide end-to-end solutions to enhance efficiency, optimize
              operations, and drive long-term success. Our services are tailored
              to meet the evolving needs of government and commercial clients
          ...
          <div className="mb-16 sm:mb-20">
            ...
            {/* Staffing Cards Grid */}
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 md:gap-2 gap-6 sm:gap-8">
