...
function EngageMentModel() {
  ...
  const getDialogContent = (id, parentOpen) => {
    ...
    switch (id) {
      case 1:
        return <ContactDialog onClose={handleClose} />;
      case 2:
        return <ContractToHireDialog onClose={handleClose} />;
      case 3:
        return (
          <DirectHireDialog parentOpen={parentOpen} onClose={handleClose} />
        );
      case 4:
        return (
          <ManagedServicesDialog
              ...
              <Dialog
                ...
                onOpenChange={(open) => {
                  if (open) {
                    ...
                    document.dispatchEvent(new Event("dialog-open"));
                  } else {
                    // Dispatch custom event when dialog closes
