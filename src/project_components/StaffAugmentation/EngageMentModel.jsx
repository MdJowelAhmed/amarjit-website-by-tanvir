        ...
        {engagementModel.map((service) => (
          ...
          >
            <CardHeader className="flex-shrink-0 pb-3 mt-2">
              <h3 className="text-lg sm:text-xl md:text-xl lg:text-2xl font-semibold md:font-bold leading-tight text-white min-h-[3rem] flex items-center justify-center">
                {service.heading}
              </h3>
            </CardHeader>

            <CardContent className="flex-grow flex items-start justify-center px-4">
              <p className="text-sm md:text-base lg:text-lg text-white leading-relaxed text-center">
                {service.content}
              </p>
            </CardContent>
            ...
            <CardFooter className="flex-shrink-0 pt-1 pb-4 flex items-center justify-center">
              ...
              >
                <DialogTrigger asChild>
                  <Button
                    type="button"
                    className="bg-transparent border rounded shadow-none h-10 text-white hover:bg-transparent hover:scale-105 flex items-center justify-center gap-2 transition-colors duration-200"
                  >
