        ...
        <div className="mb-16">
          <div className="flex flex-col lg:flex-row-reverse items-center justify-between gap-8">
            <div className="flex-1 lg:max-w-2xl order-2 lg:order-1">
              ...
              <p className="text-gray-700 text-base sm:text-lg leading-relaxed text-justify">
                We are a group of proven problem-solvers dedicated to
                simplifying how organizations source talent, essential products,
                logistics, and technology solutions. From our agile beginnings
                to becoming a trusted partner to government and commercial
                clients, we provide fast, compliant, and dependable support. Our
                strength lies in navigating the complex demands of public sector
                contracting while staying responsive to the pace of modern
                business-all with a steadfast commitment to client success.
              </p>
            </div>
            <div className="flex-shrink-0 order-1 lg:order-2">
              <Image
