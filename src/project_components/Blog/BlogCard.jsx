			...
			{cardInfo.map((card, index) => (
				<Card
					...
					<CardContent className="flex-1 px-4">
						<CardTitle className="text-2xl font-bold mb-4 line-clamp-2 text-black">
							{card.title}
						</CardTitle>
					...
					<CardFooter className="px-4 pt-0 flex  gap-3">
						<div className="flex items-center gap-3 w-full">
							...
							<div className="flex-1">
								<h4 className="font-bold text-lg text-black">{card.author}</h4>
						...
						<Link href={"/blog/5"}>
							<Button
								type="button"
								className="bg-transparent border rounded shadow-none h-10 text-black hover:bg-transparent hover:border-[#F2F2F2] flex items-center justify-center gap-2">
