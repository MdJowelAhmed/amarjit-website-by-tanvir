		...
		<div className="min-h-screen bg-transparent">
			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
				...
				<div className="max-w-4xl mx-auto">
					...
					<div className="get-in-touch-card bg-transparent rounded-lg shadow-sm border p-4 sm:p-6 mb-6 sm:mb-8 flex items-center justify-between">
						<div className="flex items-center gap-3 sm:gap-4">
							...
							<div className="flex-1 min-w-0">
								<h4 className="font-bold text-lg sm:text-xl text-black truncate">
									{card.author}
								</h4>
						...
						<Button
							onClick={handleBack}
							variant="outline"
							className="flex items-center justify-center gap-2 sm:w-auto bg-transparent text-black">
					...
					{/* Blog Content */}
					{/* <div className="bg-black rounded-lg shadow-sm border p-4 sm:p-6 lg:p-8"> */}
					<div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none">
						{/* Introduction */}
						<p className="text-black leading-relaxed text-sm sm:text-base lg:text-lg mb-6">
							{card.description}
						</p>
						...
						<div className="space-y-6 sm:space-y-8">
							...
							<section>
								...
								<ul className="list-disc pl-6 space-y-2 text-black text-sm sm:text-base">
							...
							<section>
								...
								<ul className="list-disc pl-6 space-y-2 text-black text-sm sm:text-base">
									...
									<ul className="list-disc pl-6 space-y-1 mt-2 ml-4">
							...
							{/* Conclusion */}
							<section className="get-in-touch-card border bg-gray-200 p-4 sm:p-6 rounded-lg">
								<h2 className="text-xl sm:text-2xl font-bold text-black mb-4">
									Key Takeaways
								</h2>
