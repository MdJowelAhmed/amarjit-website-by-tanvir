...
function IndustrialServices() {
  const setIndustrialBanner = {
    ...
    subheading:
      "We support mission-critical operations across both public and private sectors — delivering tailored staffing, technology, and product solutions where they’re needed most.",
  };
  return (
    <div>
      <Banner
