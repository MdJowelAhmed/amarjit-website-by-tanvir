...
function ProductProvisioningServices() {
	...
	return (
		<div className="container mx-auto px-4 sm:px-6 lg:px-32 text-black">
			{provisionHeading()}
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
				{provisionServiceList.map((service) => (
					<Card
						key={service.id}
						className=" w-full min-h-[90%] hover:shadow-lg transition-shadow duration-300 flex flex-col px-4 border-2 border-[#4f3075]">
						...
						<CardContent className="flex-grow flex flex-col justify-start  pb-6 text-black">
							<div className="space-y-2.5 flex flex-col items-start">
								...
								<ul className="pl-5 space-y-2 text-black">
