    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {engagementModel.map((service) => (
          <Card
            key={service.id}
            className="get-in-touch-card text-white w-full h-full hover:shadow-lg transition-shadow duration-300 text-center flex flex-col"
          >
            ...
            <CardFooter className="flex-shrink-0 pt-1 pb-4 flex items-center justify-center">
              <Link href={service.link}>
                <Button
                  type="button"
                  className="bg-transparent border rounded shadow-none h-10  hover:bg-transparent hover:scale-105 flex items-center justify-center gap-2 transition-colors duration-200"
                >
