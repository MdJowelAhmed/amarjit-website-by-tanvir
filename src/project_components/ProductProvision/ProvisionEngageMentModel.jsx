...
function ProvisionEngageMentModel() {
	const path = "/product-provisioning-services";
	...
	const engagementModel = [
		{
			...
			link: `/product-provisioning-services/gca-schedule`,
			content:
		...
		},
		{
			...
			link: `/product-provisioning-services/local-purchasing`,
			content:
		...
		},
		{
			...
			link: `/product-provisioning-services/cooperative-purchasing`,
			content:
		...
		},
		{
			...
			link: `/product-provisioning-services/vendor-sourcing`,
			content:
	...
	return (
		<div className="container mx-auto px-4 sm:px-6 lg:px-20">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
				{engagementModel.map((service, index) => (
					<div key={index}>
						<Card className="border-2 border-[#4f3075] text-black w-full h-full hover:shadow-lg transition-shadow duration-300 text-center flex flex-col">
							...
							<CardFooter className="flex-shrink-0 pt-1 pb-4 flex items-center justify-center">
								<Link
									href={service.link}
									className="bg-transparent border border-[#4f3075]
									text-[#4f3075] rounded shadow-none h-10 hover:bg-transparent
									hover:scale-105 flex items-center justify-center gap-2
									transition-colors duration-200 px-2 cursor-pointer z-10">
									Continue
