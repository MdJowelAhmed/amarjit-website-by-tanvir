		...
		<div className="container mx-auto px-4 sm:px-6 lg:px-32">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
				{provisionServiceList.map((service) => (
					<Card
						key={service.id}
						className="w-full min-h-[90%] hover:shadow-lg transition-shadow duration-300 flex flex-col px-4">
						...
						<CardContent className="flex-grow flex flex-col justify-start  pb-6 ">
								...
								<ul className="pl-5 space-y-2">
									{service.content.map((item, index) => (
										<li className="list-disc" key={index}>
											<p className="text-sm md:text-base lg:text-lg text-gray-600 leading-relaxed text-start">
												{item}
											</p>
										</li>
									))}
