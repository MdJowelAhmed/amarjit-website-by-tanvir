...
// function FourCardsLayout() {
// 	const path = usePathname();

// 	const isGCA = path === "/gca-schedule";
...
// 			type: "list",
// 			items: [
// 				"Office Essentials Furniture, printers, stationery",
// 				" Industrial & Safety Gear PPE, tools, materials",
// 			],
// 		},
// 		{
// 			id: 4,
...
// 													<button className="inline-flex items-center justify-center  rounded hover:bg-gray-100 transition-colors">
// 														{provideIcon({ name: "pdf" })}
// 													</button>
// 												</TableCell>
// 											</TableRow>
// 										))}
