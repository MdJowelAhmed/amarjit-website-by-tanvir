	...
	return (
		<div className="w-full">
			...
			<div className="container mx-auto flex items-center justify-center px-4 sm:px-6 lg:px-8">
				<Button
					onClick={handleBack}
					className="w-40 h-10 rounded-sm bg-transparent border-2 text-black hover:border-black hover:bg-transparent -mt-16 sm:-mt-20 lg:-mt-20 mb-6 sm:mb-8 lg:mb-12 px-6 sm:px-8 py-2 sm:py-3 text-sm sm:text-base flex items-center gap-4">
