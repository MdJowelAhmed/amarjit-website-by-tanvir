		...
		<div className="min-h-screen bg-gray-50">
			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
				...
				<div className="max-w-4xl mx-auto">
					{/* Author Info Section */}
					<div className="bg-white rounded-lg shadow-sm border p-4 sm:p-6 mb-6 sm:mb-8 flex items-center justify-between">
						<div className="flex items-center gap-3 sm:gap-4">
							...
							<div className="flex-1 min-w-0">
								<h4 className="font-bold text-lg sm:text-xl text-gray-900 truncate">
									{card.author}
								</h4>
					...
					<div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none">
						...
						<div className="space-y-6 sm:space-y-8">
							...
							{/* Conclusion */}
							<section className="border bg-gray-100 p-4 sm:p-6 rounded-lg">
								<h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">
									Key Takeaways
								</h2>
