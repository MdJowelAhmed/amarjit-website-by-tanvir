...
// 					<Card
// 						key={service.id}
// 						className="max-w-72 h-full hover:shadow-lg transition-shadow duration-300 text-center">
...
// 						<CardContent>
// 							<div>
// 								<h3 className="text-xl md:text-2xl lg:text-3xl font-semibold md:font-bold">
// 									{service.heading}
// 								</h3>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
				{staffAugmentServiceList.map((service) => (
					<Card
						...
						<CardContent className="flex-grow flex flex-col justify-start px-4 pb-6">
